...
class DDQN:
    ...
    def _update_behavior_network(self, gamma):
        ...
        with torch.no_grad():
            # use behavior net to choose the max Q value action in the next state, and use the target net to compute the target Q 
...
def main():
    ...
    parser.add_argument('--episode', default=1500, type=int)#1200
